...
export interface LundleConfig {
    babel?: (config: BabelConfig, options: LundleBabelOptions & {
        type: BabelOutputTypes;
    }) => BabelConfig;
    rollup?: (config: RollupOptions, options: LundleRollupOptions & {
...
export declare type ChokidarListener = (eventName: 'add' | 'addDir' | 'change' | 'unlink' | 'unlinkDir', path: string, stats?: Stats) => void;
