...
export declare const spawn: (cmd: string, argv: string[]) => import("child_process").ChildProcess;
export declare const loadConfig: (configFile?: string | undefined) => Promise<LundleConfig | undefined>;
...
export declare const flag: (msg: string, color?: Extract<keyof Chalk, string>) => string;
