...
module.exports.exclude = (variables, args) => args.ts
  ? ['**/*.untyped.*']
  : ['**/*.typed.*']
...
module.exports.rename = (filename, variables, args) => {
  ...
  return filename.replace('.typed', '').replace('.untyped', '').replace('.inst.', '.')
}
...
module.exports.editPackageJson = function editPackageJson (
  ...
  let pkg = {
    ...
    scripts: {
      ...
      'format:src': 'prettier --parser typescript --write "src/**/*.ts"',
